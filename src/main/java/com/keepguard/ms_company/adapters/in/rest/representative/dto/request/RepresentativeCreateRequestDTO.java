package com.keepguard.ms_company.adapters.in.rest.representative.dto.request;
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Dados para criação de representante legal")
public class RepresentativeCreateRequestDTO {
