#!/bin/bash
# =============================================================================
# 🚀 MINI MANUAL DE USO — script-deploy-github-ms-company.sh (ms-company)
# =============================================================================
# Este script automatiza o ciclo completo de desenvolvimento, build e deploy
# do serviço ms-company.
#
...
#         ghcr.io/keepguard/ms-company:develop-<sha>
#         ghcr.io/keepguard/ms-company:develop-latest
#
#   2. Commit, push, build e deploy imediato no Docker Compose local:
#      $ ./script-deploy-github-ms-company.sh up
...
#      $ ./script-deploy-github-ms-company.sh merge main
...
#      $ ./script-deploy-github-ms-company.sh merge main up
#
#   5. Pipeline Completo em 1 comando (Merge 'main' + Docker Local + K8s Produção):
#      $ ./script-deploy-github-ms-company.sh merge main up prod
#      OU simplesmente:
#      $ ./script-deploy-github-ms-company.sh full
