...
# Build Maven, Push (Commit SHA + latest) e Deploy Local do ms-company (Spring Boot)
#
# Uso:
#   ./script-deploy-github-ms-company.sh up       # Commit, Push GHCR + Sobe no Docker Local
#   ./script-deploy-github-ms-company.sh          # Commit, Push GHCR (sem subir local)
# =============================================================================
